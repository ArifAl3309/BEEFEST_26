  ...
  return (
    <div className="relative w-full h-full flex flex-col gap-3.5 select-none">
      ...
      <div
        ...
        className={`relative flex-1 w-full rounded-[30px] overflow-hidden border border-slate-800/80 bg-[#070B14] shadow-2xl transition-[cursor] touch-none select-none ${isPanning ? 'cursor-grabbing' : 'cursor-grab'
          }`}
